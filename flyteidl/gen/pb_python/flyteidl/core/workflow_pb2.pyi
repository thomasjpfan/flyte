...
class TaskNodeOverrides(_message.Message):
    __slots__ = ["resources", "extended_resources", "container_image", "pod_template", "override_security_context"]
