...
class SharedMemoryVolume(_message.Message):
...
class ExtendedResources(_message.Message):
    __slots__ = ["gpu_accelerator", "shared_memory_volume"]
    GPU_ACCELERATOR_FIELD_NUMBER: _ClassVar[int]
    SHARED_MEMORY_VOLUME_FIELD_NUMBER: _ClassVar[int]
    gpu_accelerator: GPUAccelerator
    shared_memory_volume: SharedMemoryVolume
    def __init__(self, gpu_accelerator: _Optional[_Union[GPUAccelerator, _Mapping]] = ..., shared_memory_volume: _Optional[_Union[SharedMemoryVolume, _Mapping]] = ...) -> None: ...
