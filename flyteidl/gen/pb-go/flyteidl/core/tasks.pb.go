...
type SharedMemoryVolume struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SharedMemoryVolume) Reset() {
	*x = SharedMemoryVolume{}
	if protoimpl.UnsafeEnabled {
...
func (x *SharedMemoryVolume) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SharedMemoryVolume) ProtoMessage() {}

func (x *SharedMemoryVolume) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl_core_tasks_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SharedMemoryVolume.ProtoReflect.Descriptor instead.
func (*SharedMemoryVolume) Descriptor() ([]byte, []int) {
	return file_flyteidl_core_tasks_proto_rawDescGZIP(), []int{2}
}

func (x *SharedMemoryVolume) GetMountPath() string {
	if x != nil {
		return x.MountPath
	}
	return ""
...
func (x *SharedMemoryVolume) GetMountName() string {
	if x != nil {
		return x.MountName
	}
	return ""
...
func (x *SharedMemoryVolume) GetSizeLimit() string {
	if x != nil {
		return x.SizeLimit
	}
	return ""
...
type ExtendedResources struct {
	...
	SharedMemoryVolume *SharedMemoryVolume `protobuf:"bytes,2,opt,name=shared_memory_volume,json=sharedMemoryVolume,proto3" json:"shared_memory_volume,omitempty"`
}
...
func (x *ExtendedResources) GetSharedMemoryVolume() *SharedMemoryVolume {
	if x != nil {
		return x.SharedMemoryVolume
	}
	return nil
}
...
var file_flyteidl_core_tasks_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x7a, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x71, 0x0a, 0x12, 0x53, 0x68,
	0x61, 0x72, 0x65, 0x64, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65,
	...
	0x28, 0x09, 0x52, 0x09, 0x73, 0x69, 0x7a, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0xb0, 0x01,
	...
	0x41, 0x63, 0x63, 0x65, 0x6c, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x53, 0x0a, 0x14, 0x73,
	0x68, 0x61, 0x72, 0x65, 0x64, 0x5f, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x76, 0x6f, 0x6c,
	0x75, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x66, 0x6c, 0x79, 0x74,
	0x65, 0x69, 0x64, 0x6c, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64,
	0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x52, 0x12, 0x73, 0x68,
	0x61, 0x72, 0x65, 0x64, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65,
	...
	0x02, 0x22, 0xbd, 0x01, 0x0a, 0x06, 0x4b, 0x38, 0x73, 0x50, 0x6f, 0x64, 0x12, 0x3c, 0x0a, 0x08,
	...
	0x67, 0x22, 0xa9, 0x02, 0x0a, 0x11, 0x4b, 0x38, 0x73, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x4d,
...
var file_flyteidl_core_tasks_proto_goTypes = []interface{}{
	...
	(*SharedMemoryVolume)(nil),              // 9: flyteidl.core.SharedMemoryVolume
...
var file_flyteidl_core_tasks_proto_depIdxs = []int32{
	...
	9,  // 3: flyteidl.core.ExtendedResources.shared_memory_volume:type_name -> flyteidl.core.SharedMemoryVolume
...
func file_flyteidl_core_tasks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flyteidl_core_tasks_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SharedMemoryVolume); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
